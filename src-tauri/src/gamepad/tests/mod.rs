...
use super::{gilrs_events::stick_switch_interpreter::StickSwitchButton, layers_wrapper::MockLayersWrapperTrait, layers_navigator::LayerVisitTrigger};

mod layers_examples; 

fn setup_gamepad_tick_handles_keyboard_input_events(
...
#[test]
fn gamepad_tick_handles_keyboard_input_events(){
        let keyboard_input = KeyboardInput{
            key: Key::Layout('I'),
            modifiers: vec![]
        };
       assert_eq!(
           setup_gamepad_tick_handles_keyboard_input_events(
               0_usize,
...
fn setup_gamepad_tick_handles_move_to_layer_events(
...
#[test]
fn gamepad_tick_handles_move_to_layer_events(){
    ...
    assert!(setup_gamepad_tick_handles_move_to_layer_events(
...
fn setup_gamepad_tick_handles_visit_layer_events(
...
#[test]
fn gamepad_tick_handles_visit_layer_events() {
    let new_layer_index: usize = 101_usize;
    let layer_specifier = LayerSpecifier {
        id: "some-id".to_string(), index_in_gamepad: Some(new_layer_index)};
    assert!(setup_gamepad_tick_handles_visit_layer_events(
...
fn setup_gamepad_tick_handles_move_to_or_visit_layer_events(
...
#[test]
fn gamepad_tick_handles_move_to_or_visit_layer_events() {
    let new_layer_index: usize = 101_usize;
    let layer_specifier = LayerSpecifier {
        id: "some-id".to_string(), index_in_gamepad: Some(new_layer_index)};
    assert!(setup_gamepad_tick_handles_move_to_or_visit_layer_events(
...
// #[test]
// fn gamepad_tick_handles_keyboard_and_key_down_input_events(){
//     [
