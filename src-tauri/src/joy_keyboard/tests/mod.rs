...
use super::input_controller::MockInputControllerTrait;
...
fn setup_key_click_hard_coded_matching_test(
    layer: Layer, step: Step, gamepad_key_config: Option<KeyClickConfig>){
...
fn key_click_hard_coded_layer_1_step_1() {
    setup_key_click_hard_coded_matching_test(
        Layer::First,
        Step::Step1,
        Some(joy_keyboard_keys_config().south.first_layer_step_1));
}
...
fn key_click_hard_coded_layer_1_step_2() {
    setup_key_click_hard_coded_matching_test(
        Layer::First,
        Step::Step2,
        Some(joy_keyboard_keys_config().south.first_layer_step_2));
}
...
fn key_click_hard_coded_layer_1_step_3() {
    setup_key_click_hard_coded_matching_test(
        Layer::First,
        Step::Step3,
        Some(joy_keyboard_keys_config().south.first_layer_step_3));
}
...
fn key_click_hard_coded_layer_2_step_1() {
    setup_key_click_hard_coded_matching_test(
        Layer::Second,
        Step::Step1,
        Some(joy_keyboard_keys_config().south.second_layer_step_1));
}
...
fn key_click_hard_coded_layer_2_step_2() {
    setup_key_click_hard_coded_matching_test(
        Layer::Second,
        Step::Step2,
        Some(joy_keyboard_keys_config().south.second_layer_step_2));
}
...
fn key_click_hard_coded_layer_2_step_3() {
    setup_key_click_hard_coded_matching_test(
        Layer::Second,
        Step::Step3,
        Some(joy_keyboard_keys_config().south.second_layer_step_3));
}
...
fn key_click_defaults_to_layer_1_step_1() {
    ...
    mock_input_controller
        .expect_key_down()
        .with(eq(joy_keyboard_keys_config().south.first_layer_step_1))
        .return_const(());
...
fn key_click_layer_1_step_2() {
    ...
    mock_input_controller
        .expect_key_down()
        .with(eq(joy_keyboard_keys_config().south.first_layer_step_2))
        .return_const(());
    mock_input_controller
        .expect_key_up()
        .times(1)
...
fn key_click_layer_1_step_3() {
    ...
    mock_input_controller
        .expect_key_down()
        .with(eq(joy_keyboard_keys_config().south.first_layer_step_3))
        .return_const(());
    mock_input_controller
        .expect_key_up()
        .times(1)
...
fn key_click_layer_1_step_4() {
    ...
    mock_input_controller
        .expect_key_down()
        .with(eq(joy_keyboard_keys_config().south.first_layer_step_4))
        .return_const(());
    mock_input_controller
        .expect_key_up()
        .times(2)
...
fn key_click_visit_layer_2_step_1_through_r1() {
    ...
    mock_input_controller
        .expect_key_down()
        .with(eq(joy_keyboard_keys_config().south.second_layer_step_1))
        .return_const(());
    mock_input_controller
        .expect_key_up()
        .times(1)
