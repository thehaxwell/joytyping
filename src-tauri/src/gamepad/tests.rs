...
use crate::gamepad::stick_switch_interpreter::MockStickSwitchInterpreterTrait;
...
struct AxisChangeTest {
    ...
    movement: (f32,f32),
    calls_left_stick_switch_interpreter: bool,
    calls_right_stick_switch_interpreter: bool,
...
fn setup_next_event_axis_change_test(config: AxisChangeTest) -> Option<GamepadEvent> {
    ...
    if config.calls_left_stick_switch_interpreter {
        mock_left_stick_switch_interpreter
            .expect_interpret_stick_move()
    ...
    if config.calls_right_stick_switch_interpreter {
        mock_right_stick_switch_interpreter
            .expect_interpret_stick_move()
            .with(eq(Some(config.movement.0),),eq(Some(config.movement.1)))
...
fn next_event_reflects_inconsequential_left_stick_move() {
    assert_eq!(setup_next_event_axis_change_test(AxisChangeTest {
        ...
        movement: (0.0,0.125),
        calls_left_stick_switch_interpreter: true,
        left_stick_interpretation: None,
        calls_right_stick_switch_interpreter: false,
...
fn next_event_reflects_inconsequential_right_stick_move() {
    assert_eq!(setup_next_event_axis_change_test(AxisChangeTest {
        ...
        calls_left_stick_switch_interpreter: false,
        left_stick_interpretation: None,
        calls_right_stick_switch_interpreter: true,
        right_stick_interpretation: None,
    }),None);
}
