...
use crate::{gamepad::{layers_navigator::{LayersNavigator,LayersNavigatorTrait, LayerVisit, AvailableLayerVisitsFromLayer}, Switch, switch_click_pattern_detector::SwitchClickPattern, gilrs_events::stick_switch_interpreter::StickSwitchButton}, settings_data::{LayerSpecifier, Layer, Switches, SwitchEventAndReaction, SwitchOnClickReaction}};
...
fn build_layer_visits_works() {
    let layers_and_their_available_layer_visits 
        = LayersNavigator::build_layer_visits(vec![
            Layer {
    ...
    assert_eq!(layers_and_their_available_layer_visits[0],
        AvailableLayerVisitsFromLayer {
            index_in_gamepad: 0,
            layer_visits: vec![
               LayerVisit{
    ...
    assert_eq!(layers_and_their_available_layer_visits[1],
        AvailableLayerVisitsFromLayer {
            index_in_gamepad: 1,
            layer_visits: vec![
               LayerVisit{
    ...
    assert_eq!(layers_and_their_available_layer_visits[2],
        AvailableLayerVisitsFromLayer {
            index_in_gamepad: 2,
            layer_visits: vec![
               LayerVisit{
    ...
    assert_eq!(layers_and_their_available_layer_visits[3],
        AvailableLayerVisitsFromLayer {
            index_in_gamepad: 4,
            layer_visits: vec![
               LayerVisit{
    ...
    assert_eq!(layers_and_their_available_layer_visits[4],
        AvailableLayerVisitsFromLayer {
            index_in_gamepad: 5,
            layer_visits: vec![
               LayerVisit{
    ...
    assert_eq!(layers_and_their_available_layer_visits[5],
        AvailableLayerVisitsFromLayer {
            index_in_gamepad: 6,
            layer_visits: vec![
               LayerVisit{
