use crate::joy_keyboard::keys_config::{KeysConfig, SingleKeyConfig, KeyMapping};

pub fn joy_keyboard_keys_config() -> KeysConfig{
    KeysConfig {
        south: SingleKeyConfig {
            first_layer_step_1: KeyMapping {
                key: Some(enigo::Key::Layout('I')),
                modifiers: None,
            },
            first_layer_step_2: KeyMapping{
                key: Some(enigo::Key::Layout('U')),
                modifiers: None,
            },
            first_layer_step_3: KeyMapping{
                key: Some(enigo::Key::Layout('V')),
                modifiers: None,
            },
            first_layer_step_4: KeyMapping{
                key: None,
                modifiers: None,
            },
            second_layer_step_1: KeyMapping{
                key: Some(enigo::Key::Layout('&')),
                modifiers: None,
            },
            second_layer_step_2: KeyMapping{
                key: Some(enigo::Key::Layout('}')),
                modifiers: None,
            },
            second_layer_step_3: KeyMapping{
                key: None,
                modifiers: None,
            },
            second_layer_step_4: KeyMapping{
                key: None,
                modifiers: None,
            },
        },
