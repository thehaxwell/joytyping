...
pub trait LayersNavigatorTrait {
    ...
    fn commit_potential_visit_if_trigger_switch_equals_and_unset(
        &mut self, switch: Switch);
    fn commit_potential_visit_if_trigger_switch_not_equals_and_unset(
        &mut self, switch: Switch);
    fn unset_potential_visit(&mut self);
...
impl LayersNavigatorTrait for LayersNavigator {
    ...
    fn commit_potential_visit_if_trigger_switch_equals_and_unset(
        ...
        if let Some(potential_layer_visit) = &self.potential_layer_visit {
            // switch != potential_layer_visit.trigger_switch 
            if switch == potential_layer_visit.trigger_switch.clone() {
